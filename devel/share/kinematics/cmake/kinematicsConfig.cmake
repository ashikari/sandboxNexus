...
if("TRUE" STREQUAL "TRUE")
  set(kinematics_SOURCE_PREFIX /home/ashikari/sandboxNexus/src/kinematics)
  set(kinematics_DEVEL_PREFIX /home/ashikari/sandboxNexus/devel)
  ...
  set(kinematics_INSTALL_PREFIX /home/ashikari/sandboxNexus/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ashikari <ashikari@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ashikari/sandboxNexus/src/kinematics/${idir}'.  Ask the maintainer 'ashikari <ashikari@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ashikari/sandboxNexus/devel/lib;/home/ashikari/sandboxNexus/devel/lib;/opt/ros/kinetic/lib)
